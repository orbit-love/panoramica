...
For visualizing reach, we also use graphs. In these graphs, members are the vertices
and relationships are the edges. Graphs make it easy to see who each member is connected
