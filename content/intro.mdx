...
By origin, the model is an alternative to the sales and marketing funnel. It is a new metaphor that works better
...
The Orbit Model defines a community as both i) a set of voluntary activities aligned to a common mission
and ii) the network of relationships that emerges as people do activities together. If you remove
