...
through their **actions** and **relationships**. Each member is assigned
...
<div className="md:px-48">![Advocates](/advocates.png)</div>
...
<div className="md:px-48">![Contributors](/contributors.png)</div>
...
<div className="md:px-48">![Participants](/participants.png)</div>
...
<div className="md:px-48">![Explorers](/explorers.png)</div>
...
<div className="flex flex-col w-full space-y-2">
  <div className="bg-indigo-100 px-6 py-2">
    ...
    Members have some amount of love and reach from previous experience
  </div>
  <div className="bg-indigo-100 px-6 py-2">
    <span className="font-bold">2.</span>
    Community builders create opportunities for members of all levels to act
  </div>
  <div className="bg-indigo-100 px-6 py-2">
    <span className="font-bold">3.</span>
    Members do activities according to their current love and reach
  </div>
  <div className="bg-indigo-100 px-6 py-2">
    <span className="font-bold">4.</span>
    Community builders observe activities and compare to existing patterns
  </div>
  <div className="bg-indigo-100 px-6 py-2">
    <span className="font-bold">5.</span>
    Members are placed into the orbit level with the most similar patterns
  </div>
</div>
