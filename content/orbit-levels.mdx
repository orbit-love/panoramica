...
achieve its mission, ranging from completely passive to fully active.
...
The more time, commitment, or impact of their activity, the closer they are to the center of gravity.
...
Orbit levels correspond to the level of involvement a member has
along with their ability to reach and inspire involvement from others. Members move
from outer to inner orbit levels as their love and reach increase.
...
patterns that determine what members belong to that level.

Using a product community as an example, here is a list of orbit levels and patterns
...
As you define your levels, keep in mind that repeating the same patterns more and more often
is not be a gateway to higher orbit levels. Some higher-commitment, reach-building activities are required.
For example, no matter how many likes and thumbs-ups a member gives to your content,
they will not become a Participant or a Contributor. To make the leap, they would need
to start attending events, creating content, contributing code, or equivalent.
