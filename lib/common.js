...
const common = {
  ...
  buttonClasses:
    "flex-1 px-4 py-2 text-sm font-semibold bg-indigo-700 hover:bg-indigo-600 rounded-md select-none outline-none",
  inputClasses:
    "px-2 py-2 w-64 text-sm text-black bg-indigo-100 rounded outline-none",
