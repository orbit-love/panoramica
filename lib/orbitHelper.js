...
const helper = {
  ...
  clearSelection: function (svg) {
    ...
    svg.selectAll(".show-me").attr("fill", "hidden");
  },
  ...
  drawMembers: function ({
    ...
    orbits.forEach((orbit) => {
      const membersData = membersGen({ number, seed, rand, orbit });
    ...
    bodyGroup
      .append("text")
      .attr("class", "show-me-2 clickable")
      .attr(
        "fill",
        (d) =>
          (d.ofInterest && c.selectedColor) ||
